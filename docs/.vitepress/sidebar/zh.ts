  ...
  '/': [
    {
      ...
      items: [
        ...
        { text: 'Windows 软件包管理', link: `/01_c-basic/02_${commonDirectoryName}/` },
        { text: '编程基础一', link: `/01_c-basic/03_${commonDirectoryName}/` },
        { text: '编程基础二', link: `/01_c-basic/04_${commonDirectoryName}/` },
        { text: 'C 语言入门一', link: `/01_c-basic/05_${commonDirectoryName}/` },
        { text: 'C 语言入门二', link: `/01_c-basic/06_${commonDirectoryName}/` },
        { text: '变量和常量', link: `/01_c-basic/07_${commonDirectoryName}/` },
        { text: '进制', link: `/01_c-basic/08_${commonDirectoryName}/` },
        { text: '数据类型', link: `/01_c-basic/09_${commonDirectoryName}/` },
        { text: '运算符', link: `/01_c-basic/10_${commonDirectoryName}/` },
        { text: 'C 语言中的字符集', link: `/01_c-basic/11_${commonDirectoryName}/` },
      ]
    },
    {
      text: 'C 语言进阶',
