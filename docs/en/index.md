...
hero: 
  name: "C/C++"
  text: "大、全、细"
  tagline: "『C is an efficient universal programming language, suitable for low-level development; C++ is an extension of C that supports object-oriented programming and is suitable for complex systems and high-performance applications.』"
